...
> **Windows용 강력한 링크 관리 데스크톱 애플리케이션**  
...
#### ?? 통합 링크 관리
- **URL 북마크** - 자주 방문하는 웹사이트 저장
- **파일/폴더** - 드래그 앤 드롭으로 쉽게 추가
...
- **정렬 옵션** - 이름, 최근 사용, 사용 빈도순
- **검색 기능** - 실시간 필터링

#### ?? Health Check
- **URL 상태 확인** - 웹사이트 접근 가능 여부 체크
...
- **그리드 뷰** - 상세 정보 표시
- **다크 테마** - 눈이 편한 인터페이스
- **색상 커스터마이징** - 링크별 색상 지정 (Color Picker 내장)

#### ?? 데이터 관리
- **Import/Export** - JSON 형식 백업
...
이 프로젝트는 MIT 라이선스로 배포됩니다. [LICENSE.txt](LICENSE.txt) 참조
